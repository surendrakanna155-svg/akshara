...
1. Follow SRS documents as source of truth.
2. Follow database architecture documents.
3. Follow API architecture documents.
4. Follow UI design specifications.
...
Always explain implementation steps before generating code.