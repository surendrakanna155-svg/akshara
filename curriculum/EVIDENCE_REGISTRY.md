...
**Generated:** 2026-07-15T08:03:15Z · **Authority:** single store-level source of truth for ALL owned QIE/curriculum evidence + its lifecycle state. Re-run `python -m kie.evidence.registry` to refresh.
