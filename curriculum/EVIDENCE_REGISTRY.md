...
**Generated:** 2026-07-15T09:08:40Z · **Authority:** single store-level source of truth for ALL owned QIE/curriculum evidence + its lifecycle state. Re-run `python -m kie.evidence.registry` to refresh.
...
| KDB_QIE | `knowledge/kie/qie.db` | knowledge_db | 7_qie_available | in_scope | 3.1 MB | facts:128 SF:15 seq:21 cmp:8 distr:379 · relations:41 cert/8 rej · bank:1496 |
...
| NOTATION_PAGES | `knowledge/kie/notation_pages` | staging_derived | 4_recovered_notation | in_scope | 7.2 MB |  |
