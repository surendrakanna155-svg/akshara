...
**Generated:** 2026-07-15T08:34:28Z · **Authority:** single store-level source of truth for ALL owned QIE/curriculum evidence + its lifecycle state. Re-run `python -m kie.evidence.registry` to refresh.
