...
| **1 — Foundation** | `20260612200000_finance_slice1_structures.sql` | Academic years, fee structures, lines, installment plans, settings; GET/POST/PUT structures, years, settings | School CRUD + probes |
...
| 4B1 | Finance structures (slice 1) | ❌ Not started |
