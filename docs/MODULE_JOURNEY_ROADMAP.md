...
| **Wave 1** | Data-integrity & money/identity correctness — silent failures that corrupt or hide real records | 7 | Critical x2, High x4, Medium x1 | M x5 + L x2 ≈ 1 substantial batch |
...
## Wave Wave 1 — Data-integrity & money/identity correctness — silent failures that corrupt or hide real records
