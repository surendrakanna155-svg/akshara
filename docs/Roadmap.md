...
**Current release:** v17.4 Device Auth Validation (`v17.4-device-auth-validation`)  
**Previous release:** v17.3 Authentication Hardening (`v17.3-authentication-hardening`)  
