# Future Track Design Index

**Status:** Design only — not scheduled for v1.0 / v7.8 implementation  
**Last updated:** June 2026

Each track follows the same template: goals, architecture, permissions, data model, APIs, rollout, risks.
...
Parent vision: [`../FutureVision.md`](../FutureVision.md)
