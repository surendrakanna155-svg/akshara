...
|---|---|---|
| 🟢 **RUNNABLE NOW** (content-independent, deterministic, additive) | **✅ CI-C1 DONE** (`31d22f96` — dormant `edu_blueprint_templates` + template-aware solver) · **✅ CI-C3 DONE** (`fab2807f` — multi-set A/B/C + per-set keys + PDF v2 + JSON v2, additive/dormant) · **CI-C7** (Exam Profile Engine + tier gating — NEXT) · **CI-C8** (exposure/rotation + selection-reason) · **CI-C4-schema** (outcome/competency columns + rule-first classifier) · **B12 family schema** (dormant) · **CI-E1b dormant seed** · **all APIs / DB models / tests / docs**. Option A **superseded** (owner 2026-07-08). |
