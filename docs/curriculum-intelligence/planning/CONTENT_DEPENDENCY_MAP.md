...
|---|---|---|
| 🟢 **RUNNABLE NOW** (content-independent, deterministic, additive) | **✅ CI-C1** (`31d22f96`) · **✅ CI-C3** (`fab2807f`) · **✅ CI-C7** (`2379a529`) · **✅ CI-C8** (`e62c367c` — rotation-cooldown + selection-reason, dormant) · **CI-C4-schema** (outcome/competency columns + rule-first classifier — NEXT) · **B12 family schema** (dormant) · **CI-E1b dormant seed** · **all APIs / DB models / tests / docs**. Option A **superseded** (owner 2026-07-08). |
