...
| **Current milestone** | **M0 ✅ · CI-A0 remainder ✅ · P1-CI-0 ✅** → **M1 data** awaits **CI-A1 CBSE acquisition (⏳ owner/network+licence-gated**, Risk R1). **⚑ But the lane is NOT fully blocked** ([`CONTENT_DEPENDENCY_MAP.md`](CONTENT_DEPENDENCY_MAP.md), owner 2026-07-08): the **content-independent engine/schema/API/test/docs waves are RUNNABLE NOW** on fixtures — **CI-C8** (zero-dep) → **CI-C1** (keystone solver) → **CI-C3 ∥ CI-C7** + B12 family schema + E1b dormant seed. **⚠ Running them pre-pilot reverses frozen Option A — owner confirm.** AI waves (C5/C6/C10-engine/C11) gated on P3-AI-1 + concepts. |
