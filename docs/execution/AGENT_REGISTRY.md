...
| `buewnbpvb` (bg) | bash | CONTINUOUS acquisition service (clean re-crawl) | ✅ COMPLETE | proper completion (3 no-new + frontier drained); 1728 verified / 2323 discovered (74.4%); integrity 2 not-on-disk (was 1172); 1710 PDFs/6.8G; manifest `c8f6b6bf`. 346 download-failures (403s) + CISCE(P3) not reached = honest coverage limits |
