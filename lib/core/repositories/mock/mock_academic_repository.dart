...
class MockAcademicRepository implements AcademicRepository {
  ...
  static final List<AcademicTeacherAssignment> _teacherAssignments = [
    const AcademicTeacherAssignment(
      assignmentId: 'mock-assignment-priya-8a',
      teacherId: 'HR-EMP-101',
      teacherName: 'Priya Sharma',
      classId: 'mock-class-8',
      className: '8',
    ...
    const AcademicTeacherAssignment(
      assignmentId: 'mock-assignment-patel-science-8a',
      teacherId: 'HR-EMP-103',
    ...
    const AcademicTeacherAssignment(
      assignmentId: 'mock-assignment-rao-english-8a',
      teacherId: 'HR-EMP-102',
      teacherName: 'Mrs. Rao',
      classId: 'mock-class-8',
      className: '8',
      sectionId: 'mock-section-8-A',
