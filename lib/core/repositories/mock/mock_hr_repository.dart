...
class MockHrRepository implements HrRepository {
  static const _employees = [
    HrEmployee(
      ...
      email: 'priya.sharma@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'mr.patel@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'ramesh.kumar@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'kavitha.menon@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'rajesh.iyer@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'anil.verma@nikshaos.school',
    ...
    HrEmployee(
      ...
      email: 'sunita.nair@nikshaos.school',
