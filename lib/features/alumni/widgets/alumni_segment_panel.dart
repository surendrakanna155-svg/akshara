...
/// Segment breakdown panel for alumni dashboards and reports.
class AlumniSegmentPanel extends StatelessWidget {
  const AlumniSegmentPanel({
    super.key,
    required this.title,
  ...
  final String title;
  final List<AlumniSegment> segments;
  final double height;
