...
/// Segment breakdown panel for control center dashboards and analytics.
class ControlCenterSegmentPanel extends StatelessWidget {
  const ControlCenterSegmentPanel({
    super.key,
    required this.title,
  ...
  final String title;
  final List<ControlCenterSegment> segments;
  final double height;
