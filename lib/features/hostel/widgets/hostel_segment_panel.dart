...
/// Segment breakdown panel for hostel dashboards and reports.
class HostelSegmentPanel extends StatelessWidget {
  const HostelSegmentPanel({
    super.key,
    required this.title,
  ...
  final String title;
  final List<HostelSegment> segments;
  final double height;
