...
/// Segment breakdown panel for inventory dashboards and reports.
class InventorySegmentPanel extends StatelessWidget {
  const InventorySegmentPanel({
    super.key,
    required this.title,
  ...
  final String title;
  final List<InventorySegment> segments;
  final double height;
