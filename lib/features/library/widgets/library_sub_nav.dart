...
class LibrarySubNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      container: true,
      label: 'Library module navigation',
        ...
        child: Row(
          children: [
            for (final screen in kLibraryNavScreens) ...[
              ...
              if (screen != kLibraryNavScreens.last)
...
class _LibrarySubNavTab extends StatelessWidget {
  const _LibrarySubNavTab({
    required this.label,
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      label: '$label tab',
      child: Material(
        key: QaTestKeys.moduleSubNavTab('library', label),
