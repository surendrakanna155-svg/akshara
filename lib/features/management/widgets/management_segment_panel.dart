...
/// Segment breakdown panel (donut-style list) for management dashboards.
class ManagementSegmentPanel extends StatelessWidget {
  const ManagementSegmentPanel({
    super.key,
    required this.title,
  ...
  final String title;
  final List<ManagementSegment> segments;
  final double height;
