...
class StudentHomeworkScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // DS V2 P4 — premium persona canvas behind the homework content. The
      // pending / submitted / overdue counts are honest counts (no headline %),
      // so this is a canvas-cohesion pass — presentation only.
