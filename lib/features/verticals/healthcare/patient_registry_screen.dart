...
class PatientRegistryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(healthcarePatientListProvider);
    return Scaffold(
      key: QaTestKeys.healthcarePatientScreen,
      ...
      body: items.when(
        data: (list) => ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              key: QaTestKeys.healthcarePatientTile(item.id),
        ...
        error: (e, _) => AksharaErrorState.fromFailure(
          ...
          onRetry: () => ref.invalidate(healthcarePatientListProvider),
        ),
      ),
    );
  }
