...
const Map<String, Permission> kErpRouteViewPermissions = {
  ...
  RouteNames.examReports: Permission.viewExams,
  ...
  RouteNames.inventoryStock: Permission.viewInventory,
  RouteNames.inventoryStockApprovals: Permission.viewInventory,
...
const Map<String, AdminModule> kErpRouteCapabilityModules = {
  ...
  RouteNames.inventoryStock: AdminModule.inventory,
  RouteNames.inventoryStockApprovals: AdminModule.inventory,
