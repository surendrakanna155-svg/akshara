...
ALL_TARGETS=(
  ...
  "patrol_test/workflows/patrol_batch2_approval_write_e2e_test.dart"
  "patrol_test/workflows/patrol_batch2b_approval_chains_e2e_test.dart"
  "patrol_test/auth/qa_persona_switch_test.dart"
