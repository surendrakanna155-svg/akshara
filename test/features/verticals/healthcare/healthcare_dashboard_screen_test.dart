...
void main() {
  Future<void> pumpDashboard(WidgetTester tester) async {
    ...
    final mockRepo = MockHealthcareRepository(
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          healthcareRepositoryProvider.overrideWithValue(mockRepo),
        ...
        child: MaterialApp(
          ...
          home: const HealthcareDashboardScreen(),
        ),
      ),
    );
  ...
  testWidgets('healthcare dashboard renders', (tester) async {
    await pumpDashboard(tester);
    expect(find.byKey(QaTestKeys.healthcareDashboardScreen), findsOneWidget);
  });
}
