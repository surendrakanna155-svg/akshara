...
void main() {
  Future<void> pumpDashboard(WidgetTester tester) async {
    ...
    final mockRepo = MockSalonRepository(
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          salonRepositoryProvider.overrideWithValue(mockRepo),
        ...
        child: MaterialApp(
          ...
          home: const SalonDashboardScreen(),
        ),
      ),
    );
  ...
  testWidgets('salon dashboard renders', (tester) async {
